...
| 3 | **Deck slide 5 originally cited "₹10.6k (90d)" for waste** | early deck draft, slide 5 (since restructured) | This came from a broader, earlier metric (surge in below-median cells regardless of surge_pct, which is ₹10,640 / 4.5%). The WASTE *class* is more restrictive. Slide 5 now reflects the WASTE-class numbers consistently. |
